...
// Product repository. Reads flow through the shared TTL cache in src/cache.js;
...
function createProductRepository({ store, ttlMs = DEFAULT_TTL_MS, clock = { now: () => Date.now() } }) {
