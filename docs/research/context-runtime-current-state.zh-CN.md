...
F0-v2 live binding       IMPLEMENTED / FAKE_FETCH_E2E_PASS / RUNNER_FIX_REBOUND / BINDING_REVIEW_REQUIRED / NO_PROVIDER
F0-v2 final-bound contract FINAL_BOUND_LIVE_REBOUND / RUNNER_FIX_REBOUND / BINDING_REVIEW_REQUIRED / NO_PROVIDER
...
| F0-v2 live binding               | `IMPLEMENTED / FAKE_FETCH_E2E_PASS / RUNNER_FIX_REBOUND / BINDING_REVIEW_REQUIRED / NO_PROVIDER` | authorized-provider response source、真实 usage 解析、memory-only credential seam 已接入；maxCalls 分类修复后重新绑定 executionRevision=`6d0189a998772e8d9e379f8ec56bc7f429546a2a`、surfaceHash=`583f6c974c207eb3e338b89aa345ab1aadd894fb25d83455b06ee59af13fbe0a`；旧 live attempt 已按 invalid study 记录；[验证记录](../verification/cspv-c1-f0-v2-live-binding-2026-09-13.zh-CN.md)                                    |
| F0-v2 final-bound contract       | `FINAL_BOUND_LIVE_REBOUND / RUNNER_FIX_REBOUND / BINDING_REVIEW_REQUIRED / NO_PROVIDER`          | maxCalls 分类修复后已重新绑定 exact revision/surface；candidate hash=`31663b…`，final hash=`4120e8d4c5c029ce224fb1341989cdc208d96799f1c399e736ee77aa36ea0611`；新的 live binding 尚待独立 review；[验证记录](../verification/cspv-c1-f0-v2-final-binding-2026-09-13.zh-CN.md)                                                                                                                                              |
