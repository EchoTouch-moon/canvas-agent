...
| F0-v2 runner integration         | `IMPLEMENTED / CREDENTIAL_FREE_E2E_PASS / NO_PROVIDER`  | 独立 Native-only runner 已接入 hardening adapter、逐工具 provenance、post-run snapshot→adjudication→persistence→cleanup、UNKNOWN 与 ordinary/shared failure 场景；当前 executionRevision=`467bafb0449f3c764a04dc75393bd7d3d702b865`、surfaceHash=`51bb30861320649d0d87a4d40a614b3c9a2c5fdb6f456f8cf6d001ce721b5844`，final-bound contract 和 live identity 仍 pending；[验证记录](../verification/cspv-c1-f0-v2-runner-integration-2026-09-13.zh-CN.md) |
