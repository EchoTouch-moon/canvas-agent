...
F0-v2 contract design    PASS / READY_FOR_CONTRACT_FREEZE_REVIEW / NO_PROVIDER
F0-v2 machine contract  PREPARED / FREEZE_REVIEW / NO_PROVIDER
F0-v2 runner integration IMPLEMENTED / CREDENTIAL_FREE_E2E_PASS / NO_PROVIDER
F0-v2 final-bound contract FINAL_BOUND_CANDIDATE / BINDING_REVIEW_REQUIRED / NO_PROVIDER
...
| F0-v2 contract design            | `PASS / READY_FOR_CONTRACT_FREEZE_REVIEW / NO_PROVIDER`         | 保持 F0-v1 task、prompt、Provider、24-call 预算和分层 gate；post-run snapshot→adjudication→cleanup、UNKNOWN 分层与 hardening recovery 语义均已闭合；[设计提案](../plan/c1-f0-v2-recovery-validation-design-2026-09-13.zh-CN.md)                                                                                                                                                                                                                                                       |
| F0-v2 machine contract           | `PREPARED / FREEZE_REVIEW / NO_PROVIDER`                        | `C1_F0_EXECUTION_FEASIBILITY_V2` 的 freeze-candidate hash 为 `31663b2833ea8ecf46fdc1165dd69b87e12c4ce1999fd595307368448d0606a7`；完整 evidence/outcome/firewall/artifact semantics 已 exact-bind；phase-aware candidate/final-bound validator 已准备；final bound hash、execution revision/surface hash 仍 pending；study identity 未创建；[冻结准备记录](../verification/cspv-c1-f0-v2-contract-freeze-review-2026-09-13.zh-CN.md)                                                   |
| F0-v2 runner integration         | `IMPLEMENTED / CREDENTIAL_FREE_E2E_PASS / NO_PROVIDER`          | 独立 Native-only runner 已接入 hardening adapter、逐工具 provenance、post-run snapshot→adjudication→persistence→cleanup、UNKNOWN 与 ordinary/shared failure 场景；当前 executionRevision=`164a3e101238116024e1e4eb98d97ff74faeffdb`、surfaceHash=`7f540b59755231f0e3319a641f6e3139493fab04f3a3a2ffbeb015a0531e14ed`；contract JSON 不进入 surface，final-bound contract 和 live identity 仍 pending；[验证记录](../verification/cspv-c1-f0-v2-runner-integration-2026-09-13.zh-CN.md) |
| F0-v2 final-bound contract       | `FINAL_BOUND_CANDIDATE / BINDING_REVIEW_REQUIRED / NO_PROVIDER` | 已将 runner exact revision/surface 绑定到独立 final-bound JSON；candidate hash=`31663b…`，final hash=`609629226bc0657db7e1f4318e41a901b288af1260e01a78cd46b9b0019b3d0c`；study identity 未创建，owner authorization 仍 NO_GO；[验证记录](../verification/cspv-c1-f0-v2-final-binding-2026-09-13.zh-CN.md)                                                                                                                                                                             |
