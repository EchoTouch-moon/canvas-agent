...
F0-v2 owner authorization V2 AUTHORIZED / PENDING_EXECUTION / NO_PROVIDER
...
| F0-v2 owner authorization V2     | `AUTHORIZED / PENDING_EXECUTION / NO_PROVIDER`                                                   | fresh identity=`c1-f0-v2-20260913-341fbab9`，仍为 NEVER_CLAIMED；绑定 final contract=`4120e8d4…`、execution revision=`6d0189a…`、surface=`583f6c97…`、manifest/provider hash 与 32-run 预算；等待一次性执行；[授权记录](../plan/cspv-c1-f0-v2-owner-authorization-v2-2026-09-13.zh-CN.md) |
