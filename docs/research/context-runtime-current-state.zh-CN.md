...
| F0-v2 machine contract           | `PREPARED / FREEZE_REVIEW / NO_PROVIDER`                | `C1_F0_EXECUTION_FEASIBILITY_V2` 的 freeze-candidate hash 为 `31663b2833ea8ecf46fdc1165dd69b87e12c4ce1999fd595307368448d0606a7`；final bound hash 仍 pending；U=0.125、M=14、execution revision/surface hash 仍 pending；study identity 未创建；[冻结准备记录](../verification/cspv-c1-f0-v2-contract-freeze-review-2026-09-13.zh-CN.md)                                                                                   |
