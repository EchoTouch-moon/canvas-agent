...
| F1-32 credential-free runner     | `IMPLEMENTED / CREDENTIAL_FREE_E2E_PASS / BINDING_READY / NO_PROVIDER`                               | 独立 runner 使用 32/run、1024/study 硬预算，实际生成 282-file execution inventory 与 4-file binding-control inventory（含 inherited carried-removals dependency），逐项重算 hash/aggregate 并在内存生成 FINAL_BOUND witness/contract；6 项 runner E2E、benchmark 39/309 与 headless checks 通过；identity 未创建、Provider 未执行；[runner integration](../verification/cspv-c1-f1-32-runner-integration-2026-09-14.zh-CN.md) |
