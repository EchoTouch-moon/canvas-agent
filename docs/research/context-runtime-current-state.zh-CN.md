...
| F0-v2 runner integration         | `IMPLEMENTED / CREDENTIAL_FREE_E2E_PASS / NO_PROVIDER`  | 独立 Native-only runner 已接入 hardening adapter、逐工具 provenance、post-run snapshot→adjudication→persistence→cleanup、UNKNOWN 与 ordinary/shared failure 场景；当前 executionRevision=`e46a9484818a21deec27b578b53357f3608890ef`、surfaceHash=`750ebde473bd56a3778e66573da809f569225947716058cfd992ab61b4377608`，final-bound contract 和 live identity 仍 pending；[验证记录](../verification/cspv-c1-f0-v2-runner-integration-2026-09-13.zh-CN.md) |
