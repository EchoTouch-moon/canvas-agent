...
F0-v2 final-bound contract FINAL_BOUND_LIVE_REBOUND / BINDING_REVIEW_REQUIRED / NO_PROVIDER
...
| F0-v2 final-bound contract       | `FINAL_BOUND_LIVE_REBOUND / BINDING_REVIEW_REQUIRED / NO_PROVIDER` | live binding 接入后已重新绑定 exact revision/surface；candidate hash=`31663b…`，final hash=`b340c987903318b0fed72de26007cc4a29d88cae0ac51a399eaa33cd4c6ebdab`；新增 live surface 尚待独立 binding review，study identity 未创建；[验证记录](../verification/cspv-c1-f0-v2-final-binding-2026-09-13.zh-CN.md) |
