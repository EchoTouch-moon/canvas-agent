...
| F1-32 final-bound binding     | `FINAL_BOUND / READY_FOR_INDEPENDENT_BINDING_REVIEW / NO_IDENTITY / NO_PROVIDER`                | clean main `checkoutRevision=51a409cb...`；execution hash=`27ee4691...`，control hash=`8ac49f85...`；final run-contract hash=`c4725887...`；282+4 inventories 与历史 F0-v2 anchor 已逐项校验；fresh identity 未创建；[Final-bound binding 验证](../verification/cspv-c1-f1-32-final-binding-2026-09-15.zh-CN.md) |
...
| 远端 `main`                      | `STABLE / POST_MERGE_CI_PASS`                                                                       | `main @ 51a409cb61ebb917b6584aaac1e746d123e7f6a0`；#107/#109/#110 累计 stack 已进入 main；Context Runtime CI `34921826474` completed/success；该 HEAD 是本次 F1-32 final-bound 的 clean checkout revision                                                                                                                                                                                                                  |
