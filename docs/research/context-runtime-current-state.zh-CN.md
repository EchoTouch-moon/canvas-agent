...
F0-v2 live binding       IMPLEMENTED / FAKE_FETCH_E2E_PASS / BINDING_REVIEW_REQUIRED / NO_PROVIDER
F0-v2 final-bound contract FINAL_BOUND_LIVE_REBOUND / BINDING_REVIEW_PASS / PR_#131_MERGED / NO_PROVIDER
F0-v2 authorization prep DRAFT / PENDING_OWNER_AUTHORIZATION / STACK_REVIEW_REQUIRED / NO_PROVIDER
...
| F0-v2 live binding              | `IMPLEMENTED / FAKE_FETCH_E2E_PASS / BINDING_REVIEW_REQUIRED / NO_PROVIDER` | authorized-provider response source、真实 usage 解析、memory-only credential seam、32-run live orchestration、usage schema invalidator 与 metadata-only artifacts 已完成；current executionRevision=`c072af5c4fb3245a74e457a616d0c2b78ddd3f3d`、surfaceHash=`bde57600d2f57ab48210298bcaa0b58283fe003301f617aa506eacddb46f0ae2`；fake-fetch 32 请求通过，真实 Provider 未调用；[验证记录](../verification/cspv-c1-f0-v2-live-binding-2026-09-13.zh-CN.md) |
| F0-v2 final-bound contract       | `FINAL_BOUND_LIVE_REBOUND / BINDING_REVIEW_PASS / PR_#131_MERGED / NO_PROVIDER` | live binding 接入后已重新绑定 exact revision/surface；candidate hash=`31663b…`，final hash=`b340c987903318b0fed72de26007cc4a29d88cae0ac51a399eaa33cd4c6ebdab`；PR #131 review/merge 已完成，study identity 未创建；[验证记录](../verification/cspv-c1-f0-v2-final-binding-2026-09-13.zh-CN.md) |
| F0-v2 authorization prep        | `DRAFT / PENDING_OWNER_AUTHORIZATION / STACK_REVIEW_REQUIRED / NO_PROVIDER` | fresh studyId=`c1-f0-v2-20260913-de68f062` 仅为 NOT_CLAIMED / NOT_RESERVED 候选；授权草案已更新到 live binding 的 exact hashes，但 PR #128 stack 与 owner sign-off 仍待收口；[授权准备记录](../plan/cspv-c1-f0-v2-owner-authorization-prep-2026-09-13.zh-CN.md) |
