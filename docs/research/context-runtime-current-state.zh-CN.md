...
F0-v2 final-bound contract FINAL_BOUND_LIVE_REBOUND / BINDING_REVIEW_REQUIRED / RUNNER_FIX_REQUIRED / NO_PROVIDER
F0-v2 live attempt      TERMINAL / STUDY_INVALID / CONSUMED
...
| F0-v2 final-bound contract       | `FINAL_BOUND_LIVE_REBOUND / BINDING_REVIEW_REQUIRED / RUNNER_FIX_REQUIRED / NO_PROVIDER` | live binding 接入后已重新绑定 exact revision/surface；candidate hash=`31663b…`，final hash=`b340c987903318b0fed72de26007cc4a29d88cae0ac51a399eaa33cd4c6ebdab`；真实 run 暴露 maxCalls 分类错误，当前 final binding 不再可用于重跑；[验证记录](../verification/cspv-c1-f0-v2-final-binding-2026-09-13.zh-CN.md) |
