...
|     7 | GPT-5.6 Luna      | [CR-005 Native + Shadow Benchmark Corpus](luna/CR-005-native-shadow-benchmark-corpus.md)         | `agent/luna-cr-005-native-shadow-corpus`              | IMPLEMENTATION IN PROGRESS — HARNESS_ONLY | Six-category corpus and credential-free validation complete; live matrix pending |
