...
// CR-004 Stage 1 MATRIX runner — M3/M6/M7/M8 experimental policy-screen edition
...
// 1,400 records / 300 minutes; M7/M8 bind 1,800 records / 300 minutes). A
...
async function run(): Promise<void> {
  ...
  // ---- Arm-order resolution (M5/M6/M7/M8 pre-registration; BOTH modes) ------
  // A profile with a REQUIRED arm-order mode (M5/M6/M7/M8: 'randomized') forces it —
