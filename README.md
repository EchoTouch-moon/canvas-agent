...
The post-v0.2 research line [Context Runtime v0.3](docs/architecture/context-runtime-v0.3-direction.md) concluded on 2026-08-27 as a stopped experiment: the provider-neutral observation and selection infrastructure was verified credential-free, but the value hypothesis (dynamic working-set selection improves task reliability or context efficiency) was not established, so the Working Set Runtime is not advanced to the product path. See the [final synthesis](docs/verification/context-runtime-v0.3-final-synthesis-2026-08-27.md); the research packages remain research-only and are not part of the default product path.
